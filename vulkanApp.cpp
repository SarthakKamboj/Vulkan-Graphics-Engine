...
void VulkanApp::createTextureImage() {
	...
	stbi_uc* pixels = stbi_load("images/lakers.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
...
void VulkanApp::createRenderPass() {
	...
	std::array<VkAttachmentDescription, 2> attachments = { colorAttachmentDesc, depthAttachment };
